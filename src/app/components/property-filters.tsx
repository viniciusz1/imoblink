...
export function PropertyFilters({ properties, onFilterChange }: PropertyFiltersProps) {
  ...
  const imobiliarias = Array.from(new Set(properties.map(p => p.imobiliaria))).sort();
  const quartos = Array.from(new Set(properties.map(p => p.quartos).filter(q => q > 0))).sort((a, b) => a - b);
  ...
  useEffect(() => {
    ...
    if (selectedImobiliarias.length > 0) {
      filtered = filtered.filter(p => selectedImobiliarias.includes(p.imobiliaria));
    }
  ...
  }, [selectedTipos, selectedBairros, selectedCidades, selectedImobiliarias, selectedQuartos, minPrice, maxPrice, properties, onFilterChange]);
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 sticky top-24">
      ...
      <div className="space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto pr-2">
        {/* Filtro de Preço */}
        <div>
          <h4 className="font-semibold text-gray-700 dark:text-gray-200 mb-3">Preço</h4>
          <div className="space-y-3">
            <div>
              <Label htmlFor="minPrice" className="text-sm text-gray-600 dark:text-gray-300">Valor Mínimo</Label>
              <Input
                id="minPrice"
                type="number"
                placeholder="R$ 0"
            ...
            <div>
              <Label htmlFor="maxPrice" className="text-sm text-gray-600 dark:text-gray-300">Valor Máximo</Label>
              <Input
                id="maxPrice"
                type="number"
        ...
        {/* Filtro de Tipo */}
        <div>
          <h4 className="font-semibold text-gray-700 dark:text-gray-200 mb-3">Tipo de Imóvel</h4>
        ...
        {/* Filtro de Cidade */}
        <div>
          <h4 className="font-semibold text-gray-700 dark:text-gray-200 mb-3">Cidade</h4>
          <div className="relative mb-2">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4" />
            <Input
              type="text"
            ...
            {filteredCidades.map((cidade) => (
              <div key={cidade} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleCidadeChange(cidade, checked as boolean)}
                />
                <Label
        ...
        {/* Filtro de Bairro */}
        <div>
          <h4 className="font-semibold text-gray-700 dark:text-gray-200 mb-3">Bairro</h4>
          <div className="relative mb-2">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4" />
            <Input
              type="text"
            ...
            {filteredBairros.map((bairro) => (
              <div key={bairro} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleBairroChange(bairro, checked as boolean)}
                />
                <Label
        ...
        <div>
          <h4 className="font-semibold text-gray-700 dark:text-gray-200 mb-3">Imobiliária</h4>
          <div className="relative mb-2">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 w-4 h-4" />
            <Input
              type="text"
            ...
            {filteredImobiliarias.map((imobiliaria) => (
              <div key={imobiliaria} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => handleImobiliariaChange(imobiliaria, checked as boolean)}
                />
                <Label
        ...
        {quartos.length > 0 && (
          <>
            <div>
              <h4 className="font-semibold text-gray-700 dark:text-gray-200 mb-3">Quartos</h4>
                ...
                {quartos.map((quarto) => (
                  <div key={quarto} className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => handleQuartosChange(quarto, checked as boolean)}
                    />
                    <Label
